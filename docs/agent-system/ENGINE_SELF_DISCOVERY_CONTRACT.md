...
`<роль>` должна быть vendor-neutral ролью назначенного исполнителя, а `<task-id>` должен связывать задачу с GitHub issue, Pull Request, task id или внутренним номером работы проекта.
