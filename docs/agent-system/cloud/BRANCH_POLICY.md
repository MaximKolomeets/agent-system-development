...
- release-PR `developer -> main` запрещён, если `python docs/agent-system/tools/gen_cloud_bundle.py --check` не проходит: `docs/agent-system/cloud/` должен быть синхронизирован с manifest bundle и filesystem;
