...
| 0002 | METH-OPERABILITY-01 | input/TASK-0002-METH-OPERABILITY-01-operability-versioning.md | output/RESULT-0002-METH-OPERABILITY-01-operability-versioning.md | work/docs-maintainer-01/meth-operability-01 | ожидает создания PR | материализация файлов | Operability pass: solo/governed modes, role boundaries, adapter layer, methodology_reference, source drift-control, feedback sanitization. |
