...
- asof: `2026-06-26T22:56:09+07:00`
- developer_head_sha: `6f3357cbd252ddf5a51a7d023747bcd2e037719e`
- file_count_including_readme: `16`
...
| `14` | `14_STABLE_METHODOLOGY_REFERENCE_POLICY.md` | `docs/agent-system/STABLE_METHODOLOGY_REFERENCE_POLICY.md` | `source` |
| `15` | `15_LANGUAGE_POLICY.md` | `docs/agent-system/LANGUAGE_POLICY.md` | `source` |
