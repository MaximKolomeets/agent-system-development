...
- Self-enforcement hardening в работе: methodology PR добавляет pre-emit
  ...
  manifest annotations для template non-copy/non-instantiation. До merge PR
  локальный source of truth остаётся `developer`.
