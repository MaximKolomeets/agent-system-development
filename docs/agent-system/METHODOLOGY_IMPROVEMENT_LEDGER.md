...
| `MIR-2026-001` | `operator_feedback` | self-enforcement gaps: pre-emit review, methodology CI, template annotations | `ENGINE_ENTRYPOINT.md`, CI workflow, tools, manifest/generated artifacts | `in_pr` | `current task branch` | `none` | `not_started` | `none` |
