...
| Engine меняет файлы или создаёт PR | `QUALITY_FIRST_WORKFLOW.md`, `TASK_CONTRACT.md`, `JOURNAL_FINALIZATION_POLICY.md`, `tools/check_task_ready.py`, `tools/russian_first_lint.py` | Применить acceptance/self-review, machine-readable contract, journal finalization, Russian-first lint и ready-gate. |
