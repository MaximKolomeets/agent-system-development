...
| `MIR-2026-005` | `methodology_review` | release gate must distinguish local tag precondition and off-developer ready-gate context | release evidence tooling, release authority policy | `planned` | `none` | `none` | `not_started` | `none` |
