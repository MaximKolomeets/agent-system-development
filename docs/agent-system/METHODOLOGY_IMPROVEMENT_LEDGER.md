...
| `MIR-2026-004` | `operator_feedback` | release boundary near-miss: target tag may already exist before release PR | release evidence tooling, release authority policy, manifest/generated artifacts | `in_pr` | pending_PR | `none` | `not_started` | `none` |
