...
| `MIR-2026-003` | `operator_feedback` | commit-language tooling overlap must be reconciled into one canonical gate | commit-message validator, methodology CI, manifest/generated artifacts, adoption docs | `planned` | `none` | `none` | `not_started` | `none` |
