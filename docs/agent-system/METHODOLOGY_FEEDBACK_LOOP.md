...
- создать docs-only journal closure cleanup task с фактическими merge данными внутри target repository, если сработало per-task исключение или release gate;
