...
4. Для задач, которые меняют файлы, создают Pull Request, выполняют adoption/bootstrap или требуют полного воспроизводимого scope, использовать self-contained Engine-блок по `docs/agent-system/ORCHESTRATOR_RESPONSE_STANDARD.md`.
