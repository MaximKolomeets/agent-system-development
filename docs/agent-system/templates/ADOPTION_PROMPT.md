...
Adoption prompt должен требовать `methodology_reference`: repository,
`source_ref`, source commit SHA, checked_at и reference_type. Канон
спецификации — `docs/agent-system/ENGINE_ENTRYPOINT.md` → раздел
