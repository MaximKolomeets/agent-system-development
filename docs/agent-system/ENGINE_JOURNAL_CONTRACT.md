...
Допустимый marker должен быть единственным top-level полем `Статус финализации` вне fenced/indented примеров. Второе либо противоречащее поле блокирует RESULT.
