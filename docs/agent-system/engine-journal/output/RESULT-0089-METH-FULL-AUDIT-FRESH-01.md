...
| 3 | Целостность журнала | finding(major) | seq 0001–0088 непрерывны, парность 88↔88, task-id совпадают, INDEX-ссылки валидны. НО 0086/0087/0088 — merged work PR (#235/#236/#237 MERGED), а INDEX/RESULT на момент аудита содержали stale pre-merge status surfaces. Это substantive entries (не lifecycle terminal-fold), 3 шт. > допустимой одной складки → M-01. |
