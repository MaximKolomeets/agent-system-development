...
- asof: `2026-06-22T10:54:02+07:00`
- developer_head_sha: `878ccd2213497bc8cdb201cef220f583cc53050d`
...
| `04` | `04_ENGINE_JOURNAL_CONTRACT.md` | `docs/agent-system/ENGINE_JOURNAL_CONTRACT.md` | `source` |
| `05` | `05_BRANCH_POLICY.md` | `docs/agent-system/BRANCH_POLICY.md` | `source` |
| `06` | `06_ENGINE_ENTRYPOINT.md` | `docs/agent-system/ENGINE_ENTRYPOINT.md` | `source` |
| `07` | `07_PROJECT_FILE_MAP.md` | `docs/agent-system/PROJECT_FILE_MAP.md` | `generated` |
| `08` | `08_ADOPTION_TRANSFER_MANIFEST_yml.md` | `docs/agent-system/ADOPTION_TRANSFER_MANIFEST.yml` | `source` |
| `09` | `09_CURRENT_STATE.md` | `docs/agent-system/CURRENT_STATE.md` | `history_state` |
| `10` | `10_NEXT_STEPS.md` | `docs/agent-system/NEXT_STEPS.md` | `history_state` |
| `11` | `11_ENGINE_JOURNAL_INDEX.md` | `docs/agent-system/engine-journal/INDEX.md` | `journal` |
